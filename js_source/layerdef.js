...
//=====================
	function layerdef(type){
		...
		//	dit maakt de layers voor de cycleway tags
			...
			//pois
			make_a_layer(QURL + "?data=(node[shop=bicycle](bbox);node[amenity=bicycle_repair_station](bbox);way[shop=bicycle](bbox);node(w););out;", "#0000a0", name="#l#shop=bicycle/repair station", 0.7, false),
